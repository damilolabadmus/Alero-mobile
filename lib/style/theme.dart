...
class Colors {
  ...
  static const Color biodataBlue = const Color(0xFFF5F9FA);
  static const Color biodataRed = const Color(0xFFF9F5FA);
  static const Color biodataGreen = const Color(0xFFF6FAF5);
  static const Color biodataYellow = const Color(0xFFFFF9F0);

  static const Color dividerLine = const Color(0xFFF4F4F4);

  static const Color iconColor = const Color(0xFF639EB5);

  static const Color overviewTextGrey = const Color(0xFFBABABA);
  static const Color overviewTextDarkGrey = const Color(0xFF929292);
  static const Color overviewActiveBg = const Color(0xFF00ADEF);
  static const Color overviewInactiveBg = const Color(0xFFB3A369);
  static const Color overviewCardBg = const Color(0xFFF5F9FA);
  static const Color overviewTextLightGrey = const Color(0xFF888888);
  static const Color overviewTextBlue = const Color(0xFF639EB5);

  static const Color trendsTextBlue = const Color(0xFF7CB2C5);
  static const Color trendsTextBlack = const Color(0xFF757D80);
  static const Color trendsGraphGrey = const Color(0xFFCAD5D9);
  static const Color trendsGraphRed = const Color(0xFFE2574C);
