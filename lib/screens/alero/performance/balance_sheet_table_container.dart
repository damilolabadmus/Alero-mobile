                        ...
                        color:  MaterialStateProperty.resolveWith<Color>(
                          ...
                          cells: [
                             DataCell(Text(balanceSheetDepData[index].product == "Demand_Deposits" ? 'CURRENT'
                              ...
                              style: balanceSheetDepData[index].product == 'Total Deposits' ? kMyBalanceSheetHeaderStyle : kDealsHeaderStyle)),
                            ...
                            DataCell(Text(balanceSheetDepData[index].achievementPercent.toString(), style: balanceSheetDepData[index].product == 'Total Deposits' ? kMyBalanceSheetHeaderStyle : kDealsHeaderStyle)),
                      ]);}
                    ),
                    )
                  ),
                  ...
                  child: SingleChildScrollView(
                      ...
                      child: DataTable(
                        ...
                        return DataRow(
                            ...
                            cells: [
                              DataCell(Text(balanceSheetLoanData[index].product, style: balanceSheetLoanData[index].product == 'Total Loans' ? kMyBalanceSheetHeaderStyle : kDealsHeaderStyle)),
                              ...
                              DataCell(Text(balanceSheetLoanData[index].achievementPercent.toString(), style: balanceSheetLoanData[index].product == 'Total Loans' ? kMyBalanceSheetHeaderStyle : kDealsHeaderStyle)),
                        ]);}
                      ),
                      )
                  ),
