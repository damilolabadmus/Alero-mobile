  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          padding: EdgeInsets.only(left: 8.0, top: 5, right: 5.0),
          child: Container(
            child: Padding(
                  ...
                  Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          width: widget.searchedCprData.isEmpty || widget.searchedCprData == null ? 0 : 150,
                          padding: EdgeInsets.symmetric(horizontal: 7.0,
                            vertical: 3),
                          decoration: BoxDecoration(
                            color: Colors.black38,
                            borderRadius: BorderRadius.circular(4.0)),
                          child: Text(widget.searchedCprData.isEmpty || widget.searchedCprData == null ? '' : widget.searchedCprData[0].customerName.toString(),
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: 14.0,
    ...
    bottomNavigationBar: CprBottomNavigationBar(barItemSelected: true, searchedCustomer: widget.isSearched, isFirstPage: true));
  }
}
