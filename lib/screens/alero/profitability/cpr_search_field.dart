...
class _CprSearchFieldState extends State<CprSearchField> {
  ...
  void initState() {
    ...
    // getCprByCustomerNumber('012337432');
  }
                ...
                decoration: InputDecoration(
                    ...
                    suffixIcon: InkWell(
                      onTap: () {
                        ...
                        Navigator.push(context, MaterialPageRoute(builder: (context) => SearchCprPage(searchedCprData: searchedCprData, isSearched: isSearched)));
                        },
                      child: Padding(
