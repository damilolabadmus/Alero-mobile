...
class PlTitleContainer extends StatelessWidget {
  String measure, subTitle, subText, selectedDate/*, selectedState*/;
  final Function selectDate;
  final Function updateSelectedDate;

  PlTitleContainer ({this.measure, this.subTitle, this.subText, this.selectedDate, /*this.selectedState,*/ this.selectDate, this.updateSelectedDate});
