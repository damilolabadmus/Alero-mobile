              ...
              Row(
                ...
                children: [
                  LoansItem(loansLine1: 'Actual', loansLine2: 'Loans',
                      value: "${double. parse((data.actualLoans/divisor).toStringAsFixed(2))}b"),
                  LoansItem(loansLine1: ' ', loansLine2: 'DoD',
                      value: data.actualLoansChange.toString()),
                  LoansItem(loansLine1: 'Average', loansLine2: 'Loans',
                      value: "${double. parse((data.averageLoans/divisor).toStringAsFixed(2))}b"),
                  LoansItem(loansLine1: ' ', loansLine2: 'DoD',
                      value: data.averageLoansChange.toString()),
                ],
              ),
              SizedBox(
                height: 10.0,
