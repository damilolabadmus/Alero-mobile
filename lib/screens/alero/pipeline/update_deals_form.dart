...
class _UpdateDealFormState extends State<UpdateDealForm> {
  ...
  // SubStatus
  ButtonTheme subStatusAndroidDropDown(List<DealsListOfSubstatus> dropDownList) {
    return ButtonTheme(
      alignedDropdown: true,
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ...
          Text(
            'You have successfully updated the deal status for ' + widget.pendingStatus.customerName.toString() + '.',
            style: TextStyle(
              fontSize: 15,
              height: 2,
              color: Colors.black54,
