...
class CustomerDetailsResponse {
  ...
  CustomerDetailsResponse(
    ...
    this._customerRelationshipAge = customerRelationshipAge;
    this._customerGender = customerGender;
    this._isMinor = isMinor;
    this._mobileNumber = mobileNumber;
    this._mobileNumber2 = mobileNumber2;
    ...
    this._nextOfKinName = nextOfKinName;
    this._nextOfKinRelationship = nextOfKinRelationship;
    this._nextOfKinAddress = nextOfKinAddress;
    this._nextOfKinMobileNumber = nextOfKinMobileNumber;
    this._identificationType = identificationType;
    this._identificationNo = identificationNo;
    this._identificationIssueDate = identificationIssueDate;
    this._identificationExpiryDate = identificationExpiryDate;
    this._haveActiveAccount = haveActiveAccount;
    this._isPepCustomer = isPepCustomer;
    this._customerStatus = customerStatus;
    this._recordStat = recordStat;
    this._authStat = authStat;
    this._isStaff = isStaff;
    this._bankingProfile = bankingProfile;
    this._businessSegmentCode = businessSegmentCode;
    this._businessSegment = businessSegment;
    this._subBusinessSegment = subBusinessSegment;
    this._retailSubBusSegment = retailSubBusSegment;
    this._alpherCode = alpherCode;
  ...
  CustomerDetailsResponse.fromJson(Map<String, dynamic> json) {
    ...
    _customerTitle = json['customerTitle'];
    _customerName = json['customerName'];
    _customerType = json['customerType'];
    _customerDob = json['customerDob'];
    _customerAge = json['customerAge'];
    _customerRelationshipAge = json['customerRelationshipAge'];
    _customerGender = json['customerGender'];
    _isMinor = json['isMinor'];
    _mobileNumber = json['mobileNumber'];
    _mobileNumber2 = json['mobileNumber2'];
    _customerEmail = json['customerEmail'];
    _bvn = json['bvn'];
    _tin = json['tin'];
    _rcNumber = json['rcNumber'];
    _occupation = json['occupation'];
    _businessType = json['businessType'];
    _customerAddress = json['customerAddress'];
    _customerCity = json['customerCity'];
    _customerState = json['customerState'];
    _customerLga = json['customerLga'];
    _bankRegion = json['bankRegion'];
    _country = json['country'];
    _nationality = json['nationality'];
    _exposureCountry = json['exposureCountry'];
    _isDeceased = json['isDeceased'];
    _branchCode = json['branchCode'];
    _branchName = json['branchName'];
    _introducer = json['introducer'];
    _introducerName = json['introducerName'];
    _rmCode = json['rmCode'];
    _rmName = json['rmName'];
    _employmentStatus = json['employmentStatus'];
    _employer = json['employer'];
    _maritalStatus = json['maritalStatus'];
    _motherMaidenName = json['motherMaidenName'];
    _nextOfKinName = json['nextOfKinName'];
    _nextOfKinRelationship = json['nextOfKinRelationship'];
    _nextOfKinAddress = json['nextOfKinAddress'];
    _nextOfKinMobileNumber = json['nextOfKinMobileNumber'];
    _identificationType = json['identificationType'];
    _identificationNo = json['identificationNo'];
    _identificationIssueDate = json['identificationIssueDate'];
    _identificationExpiryDate = json['identificationExpiryDate'];
    _haveActiveAccount = json['haveActiveAccount'];
    _isPepCustomer = json['isPepCustomer'];
    _customerStatus = json['customerStatus'];
    _recordStat = json['recordStat'];
    _authStat = json['authStat'];
    _isStaff = json['isStaff'];
    _bankingProfile = json['bankingProfile'];
    _businessSegmentCode = json['businessSegmentCode'];
    _businessSegment = json['businessSegment'];
    _subBusinessSegment = json['subBusinessSegment'];
    _retailSubBusSegment = json['retailSubBusSegment'];
    _alpherCode = json['alpherCode'];
    _alpherName = json['alpherName'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['customerTitle'] = this._customerTitle;
    data['customerName'] = this._customerName;
    data['customerType'] = this._customerType;
    data['customerDob'] = this._customerDob;
    data['customerAge'] = this._customerAge;
    data['customerRelationshipAge'] = this._customerRelationshipAge;
    data['customerGender'] = this._customerGender;
    data['isMinor'] = this._isMinor;
    data['mobileNumber'] = this._mobileNumber;
    data['mobileNumber2'] = this._mobileNumber2;
    data['customerEmail'] = this._customerEmail;
    data['bvn'] = this._bvn;
    data['tin'] = this._tin;
    data['rcNumber'] = this._rcNumber;
    data['occupation'] = this._occupation;
    data['businessType'] = this._businessType;
    data['customerAddress'] = this._customerAddress;
    data['customerCity'] = this._customerCity;
    data['customerState'] = this._customerState;
    data['customerLga'] = this._customerLga;
    data['bankRegion'] = this._bankRegion;
    data['country'] = this._country;
    data['nationality'] = this._nationality;
    data['exposureCountry'] = this._exposureCountry;
    data['isDeceased'] = this._isDeceased;
    data['branchCode'] = this._branchCode;
    data['branchName'] = this._branchName;
    data['introducer'] = this._introducer;
    data['introducerName'] = this._introducerName;
    data['rmCode'] = this._rmCode;
    data['rmName'] = this._rmName;
    data['employmentStatus'] = this._employmentStatus;
    data['employer'] = this._employer;
    data['maritalStatus'] = this._maritalStatus;
    data['motherMaidenName'] = this._motherMaidenName;
    data['nextOfKinName'] = this._nextOfKinName;
    data['nextOfKinRelationship'] = this._nextOfKinRelationship;
    data['nextOfKinAddress'] = this._nextOfKinAddress;
    data['nextOfKinMobileNumber'] = this._nextOfKinMobileNumber;
    data['identificationType'] = this._identificationType;
    data['identificationNo'] = this._identificationNo;
    data['identificationIssueDate'] = this._identificationIssueDate;
    data['identificationExpiryDate'] = this._identificationExpiryDate;
    data['haveActiveAccount'] = this._haveActiveAccount;
    data['isPepCustomer'] = this._isPepCustomer;
    data['customerStatus'] = this._customerStatus;
    data['recordStat'] = this._recordStat;
    data['authStat'] = this._authStat;
    data['isStaff'] = this._isStaff;
    data['bankingProfile'] = this._bankingProfile;
    data['businessSegmentCode'] = this._businessSegmentCode;
    data['businessSegment'] = this._businessSegment;
    data['subBusinessSegment'] = this._subBusinessSegment;
    data['retailSubBusSegment'] = this._retailSubBusSegment;
    data['alpherCode'] = this._alpherCode;
    data['alpherName'] = this._alpherName;
    return data;
  }
}